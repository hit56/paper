...
2. 2023 引用量79 [GENERATIVE SPEECH RECOGNITION ERROR CORRECTION WITH LARGE LANGUAGE MODELS AND TASK-ACTIVATING PROMPTING](https://assets.amazon.science/77/26/6c265e0a42d7a40d2ee8bdd158e6/generative-speech-recognition-error-correction-with-large-language-models-and-task-activating-prompting.pdf)
...
2. 2020 ICASSP [Controllable Time-Delay Transformer for Real-Time Punctuation Prediction and Disfluency Detection](https://arxiv.org/pdf/2003.01309)
