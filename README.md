...
##
1. 2020 引用量54 [CONTROLLABLE TIME-DELAY TRANSFORMER FOR REAL-TIME PUNCTUATION PREDICTION AND DISFLUENCY DETECTION](https://arxiv.org/pdf/2003.01309) 达摩院写的文章。把标点和顺滑联合建模。
